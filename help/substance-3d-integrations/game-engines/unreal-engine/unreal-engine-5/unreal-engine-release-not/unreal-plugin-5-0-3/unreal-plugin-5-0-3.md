...
breadcrumb-title: ''
description: Consulte as notas de versão do plug-in Unreal Engine 5 versão 5.0.3 para saber mais sobre novos recursos, aprimoramentos e correções de erros.
...
* baseColor indo para o deslocamento de Posição Mundial
