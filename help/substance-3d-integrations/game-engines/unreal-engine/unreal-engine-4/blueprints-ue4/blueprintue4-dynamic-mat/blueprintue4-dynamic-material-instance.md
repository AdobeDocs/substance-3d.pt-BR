...
1. Adicione um nó de Loop For. Aqui você executa o loop pelas Texturas. Tome o resultado das Texturas Get Substance como a matriz de entrada.
...
1. Adicione um Valor de Parâmetro de Textura Set de Substance. O destino é a variável MID e o nome do parâmetro é a variável de nome MID. O Valor é o Elemento Array do Nó ForEachLoop.
