...
# Sombreador de Substance

Um sombreador de Substance é o vínculo entre um ativo de Substance e um Cinema 4D.

O sombreador de Substance pode ser encontrado no menu de seleção Editor de material de Cinema 4D normal, conforme mostrado na captura de tela abaixo:

![](../../../assets/cinema-4d-6.png){width="500px"}

Depois de adicionar manualmente um sombreador de Substance, ele não tem nenhum ativo de Substance vinculado. Ele ficará parecido com o mostrado abaixo e, quando renderizado, o material ficará parecido com a imagem à direita:
