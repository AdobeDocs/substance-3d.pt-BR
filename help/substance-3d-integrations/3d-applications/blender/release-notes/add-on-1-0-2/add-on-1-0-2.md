...
***Notas de versão do Complemento versão 1.0.2***

* *Correção do problema com nós que não se conectavam no Blender versão 3.4.*
* *Atualizações secundárias: limpeza de código, remoção de redundâncias e formalização de nomes de variáveis.*
