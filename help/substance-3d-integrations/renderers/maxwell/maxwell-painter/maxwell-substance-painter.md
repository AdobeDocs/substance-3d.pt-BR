...
Você pode escolher os Modelos de saída Maxwell (aspereza metálica) ou Maxwell (textura reluzente de Specular) para exportar texturas para renderização no Maxwell.

![](../../../assets/maxwell-output.png){width="500px"}

## Aplicação de texturas no Maxwell
...
Se você tiver vários conjuntos de texturas exportados do Substance Painter, a integração usará a convenção de nomenclatura da textura para atribuir mapas de textura correspondentes.
